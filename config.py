...
UPGRADES = {
    # TODO: пофиксить скейлинг. % прибавляются от ОБЩЕГО. т.е. растут экспонентно
    "damage": {
        "name": "Усиление атаки",
    ...
    # TODO: есть ощущение, что пушка не дамажит
    # "melee": {
    #     "name": "Взрывная волна",
...
UPGRADE_ATTACK_SPEED_MULTIPLIER = 0.02  # -2% задержки
UPGRADE_VAMPIRISM_PERCENT = 0.05  # 5% вампиризма
